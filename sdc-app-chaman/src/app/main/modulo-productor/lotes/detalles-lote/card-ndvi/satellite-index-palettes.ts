...
const VEGETATION_PALETTE: SatellitePaletteConfig = {
  ...
  stops: [
    ...
    { at: 0, rgb: [198, 139, 93] },
    { at: 0.08, rgb: [224, 196, 134] },
    { at: 0.15, rgb: [234, 223, 154] },
    { at: 0.22, rgb: [213, 232, 120] },
    { at: 0.32, rgb: [158, 219, 93] },
    { at: 0.5, rgb: [66, 170, 73] },
    { at: 0.72, rgb: [21, 122, 51] },
  ],
  legend: [
    { label: 'Bajo', color: 'rgba(224, 196, 134, 0.82)' },
    { label: 'Medio', color: 'rgba(158, 219, 93, 0.82)' },
    { label: 'Alto', color: 'rgba(66, 170, 73, 0.82)' },
  ],
};
