...
if (!/<key>ITSAppUsesNonExemptEncryption<\/key>\s*<false\/>/.test(iosInfo)) {
  throw new Error('iOS Info.plist: debe conservar la declaración de cifrado exento autorizada');
}
...
requireText(xcodeProject, 'CURRENT_PROJECT_VERSION = 4;', 'Proyecto iOS');
