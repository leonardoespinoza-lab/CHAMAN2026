...
export const PREDICCIONES_SANITARIAS_CRON_ENABLED =
  ...
  (process.env.PREDICCIONES_SANITARIAS_CRON_ENABLED === undefined ||
    process.env.PREDICCIONES_SANITARIAS_CRON_ENABLED.trim().toLowerCase() ===
      'true');
export const PREDICCIONES_SANITARIAS_CONCURRENCY = openMeteoNumber(
  process.env.PREDICCIONES_SANITARIAS_CONCURRENCY,
  5,
  1,
  10,
  true,
);
export const PREDICCIONES_FRUTALES_EXPERIMENTALES_ENABLED =
  process.env.PREDICCIONES_FRUTALES_EXPERIMENTALES_ENABLED === 'true';
